...
*Contraintes.* Hébergement sur l'infrastructure de l'ÉTS ; ressources d'une VM ; environ 400 étudiants en examen ; données personnelles soumises à la Loi 25 ; charge de travail d'un cours de projet individuel.
